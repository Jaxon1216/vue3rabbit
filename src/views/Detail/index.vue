    ...
    <div class="container">
      <div class="bread-container" v-if="goods.categories">
        <el-breadcrumb separator=">">
          ...
          <!-- 首次渲染报错原因：goods一开始是空对象，访问category得到undefined -->
          <!-- 1.可选链的语法?.  -->
          <!-- 2.v-if保证有数据才渲染 -->
          ...
          <el-breadcrumb-item v-if="goods.name">{{ goods.name }}</el-breadcrumb-item>
        </el-breadcrumb>
      </div>
      <!-- 商品信息 -->
          ...
          <div class="goods-info">
            <div class="media">
              ...
              <ul class="goods-sales">
                ...
                <li>
                  <p>品牌信息</p>
                  <p v-if="goods.brand?.name"> {{ goods.brand.name }} </p>
